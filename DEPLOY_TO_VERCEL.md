...
> Note: Authentication is planned. You can skip NEXTAUTH_* until implemented.
...
```env
# Authentication (Planned — can omit until implemented)
...
- [ ] Test authentication flows (planned)
...
- [NextAuth.js with Vercel](https://next-auth.js.org/deployment) (planned)
